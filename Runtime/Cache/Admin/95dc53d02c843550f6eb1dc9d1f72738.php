    ...
    <script>
        ...
        function out_excel(){
            parent.layer.open({
                ...
                area: ['350px', '500'],
                title: '导出用户',
                content: '<?php echo U("Member/out_excel");?>'
            });
        }
        //编辑用户
        function edit(id){
...
<div class="list">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
        <form action="/hg_2016/Admin/Member/edit_mul_do" method="post">
            <thead>
            <tr class="action">
                ...
                <td width="5%"><div align="center">登录名</div></td>
                <td width="4%"><div align="center">开户形式</div></td>
            ...
            <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr id="del<?php echo ($vo["id"]); ?>" class="list">
                    ...
                    <td><div align="center"><del><?php echo ($vo["sex"]); ?></del></div></td>
                    <td><div align="center"><a class="a_button" href="javascript:;" ><del><?php echo (tel_sub($vo["tel"])); ?></del></a></div></td>

                    <td><div align="center"><del><?php echo ($vo["agentname"]); ?></del></div></td>
                    <td><div align="center"><del><?php echo ($vo["groupname"]); ?></del></div></td>
                    <td><div align="center"><del><?php echo ($vo["department"]); ?></del></div></td>
                    ...
                    <td><div align="center"><del><?php echo ($vo["loginuser"]); ?></del></div></td>
                    <td><div align="center"><del><?php echo ($vo["kaihuform"]); ?></del></div></td>
                    <td><div align="center">
                        <a class="a_button" href="javascript:;" ><del>编辑</del></a>
                        <a class="a_button" href="javascript:;" ><del>销户</del></a></if>
                    </div></td>
