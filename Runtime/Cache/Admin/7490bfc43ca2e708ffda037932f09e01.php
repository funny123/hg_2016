...
<div class="nav">
    <div class="nav_title">
        <h4><img class="nav_img" src="/hg_2016/Public/Admin/img/tab.gif" /><span class="nav_a">激活客户列表</span></h4>

    </div>
    <div class="nav_title" id="shai_x">
    <form name="form1" class="formSo" method="get" action="<?php echo U('NewMember/member_jh');?>">
    ...
    <div class="nav_title" id="paixu">
        <form name="form3" class="formPx" method="get" action="<?php echo U('NewMember/member_jh');?>">
            <input name="order" type="hidden" id="order" value="" class="s26" />
...
<div class="list">
      <table width="1800px" border="0" cellpadding="0" cellspacing="0" class="list_table">
          <form name="searchform" method="get" action="<?php echo U('NewMember/member_jh');?>">
              <select name="member">
      ...
      <thead>
        <tr class="action">
          ...
          <td width="1%" id="add1"><div align="center">ID</div></td>
            ...
            <td width="2%"><div align="center" id="jihuot">
          ...
          <td width="2%"><div align="center" id="realn">
            ...
            <td width="2%"><div align="center" id="codei">
          ...
          <td width="1%"><div align="center">电话</div></td>
            <td width="1%"><div align="center">地址</div></td>
          ...
          <td width="2%"><div align="center" id="group">
            ...
            <td width="1%"><div align="center">生日</div></td>
            <td width="2%"><div align="center">激活资金
        ...
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): if($vo["cong"] == 1 or $vo["cong1"] == 1): ?><tr id="del<?php echo ($vo["id"]); ?>" class="list" align="center" bgcolor="">
                ...
                <td>
                    ...
                    <td>
                        <div align="center"><?php echo ($vo["address"]); ?></div>
                    </td>
                ...
                <td>
                    <div align="center"><?php echo ($vo["groupname_x"]); ?></div>
                </td>
                <td>
