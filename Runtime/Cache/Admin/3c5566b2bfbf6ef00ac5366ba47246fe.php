...
<title>登录</title> 
<link rel="stylesheet" href="/hg_2016/Public/Admin/css/login.css">
...
<div class="main">
	...
	<form name="loginform" id="loginform" method="post" action="<?php echo U('Public/login');?>" onSubmit="return check_login()">
	  <table width="65%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	      <td width="49%" rowspan="3"><p></p>
	      <!-- <div id="code_img">
	      <img style="border:1px solid #D4E7F6; cursor:pointer;width:180px; height:50px; text-transform: uppercase; margin-top:12px; font-size:16px; padding-left:3px;"  src="/hg_2016/Public/Admin/img/logo.png"  />
	      </div> -->
          </td>
	      <td width="20%">用户名：</td>
	    ...
	    <tr>
	      <td>验证码：</td>
	      <td><input type="text" name="code" class="infoInput" id="code" placeholder="点击刷新" maxlength="4" value="" style="width:80px; height:30px; text-transform: uppercase; margin-top:12px; font-size:16px; padding-left:3px;" />
	      <input type="hidden" id="check_code" value="0"></td>
	      <td>
	      <div id="code_img">
	      <img style="border:1px solid #D4E7F6; cursor:relative;width:90px; height:40px;  margin-top:12px; font-size:16px; padding-left:0px; position: relative;	left: -88px; " title="点我刷新哦！" src="<?php echo U('Public/verify');?>"onclick='this.src=this.src+"?"+Math.random' class="yzm-img" />
	      </div>
          </td>
        </tr>
	    <tr>
